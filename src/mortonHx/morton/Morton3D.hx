...
import mortonHx.ds.Vertex3i;
@:forward
abstract Point3DInt( Vertex3i<Int> ) from Vertex3i<Int> to Vertex3i<Int> {
    public inline function new( x: Int, y: Int, z: Int ){
        this = new Vertex3i( x, y, z );
    }
    @:to
...
abstract Morton3D(Int) from Int to Int {
    ...
    public static inline var maxIntX = 1023; 
